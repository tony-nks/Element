  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10 col-sm-9">
			<input class="form-control width-250" maxlength="30" type="text" name="editedxfield[0]" value="<?php echo $editedxfield[0];?>" /><span class="text-muted text-size-small"><i class="fa fa-exclamation-circle position-left position-right"></i> <?php echo $lang['xf_lat']; ?></span>
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3"><?php echo $lang['xfield_xdescr']; ?></label>
		  <div class="col-md-10 col-sm-9">
			<input class="form-control width-350" maxlength="100" type="text" name="editedxfield[1]" value="<?php echo $editedxfield[1];?>" />
		  </div>
		 </div>	
		<div class="form-group">
