	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4">
			{$lang['edit_fdate']}&nbsp;<input data-rel="calendardate" type="text" name="fromregdate" id="fromregdate" class="form-control" style="width:140px;" value="">
		  </div>
		  <div class="col-sm-4">
			{$lang['edit_tdate']}&nbsp;<input data-rel="calendardate" type="text" name="toregdate" id="toregdate" class="form-control" style="width:135px;" value="">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-sm-4">{$lang['edit_entedate']}</label>
		  <div class="col-sm-4">
			{$lang['edit_fdate']}&nbsp;<input data-rel="calendardate" type="text" name="fromentdate" id="fromentdate" class="form-control" style="width:140px;" value="">
		  </div>
		  <div class="col-sm-4">
			{$lang['edit_tdate']}&nbsp;<input data-rel="calendardate" type="text" name="toentdate" id="toentdate" class="form-control" style="width:135px;" value="">
		  </div>
		 </div>
		<div class="form-group">
		  <div class="col-sm-6">
  ...
  <div class="panel-body">
	  ...
	  <div class="col-md-7">
		<div class="form-group">
		  ...
		  <div class="col-md-8">
			{$lang['edit_fdate']}&nbsp;<input class="form-control" style="width:140px;" data-rel="calendardate" type="text" name="fromregdate" id="fromregdate" value="{$fromregdate}">
			{$lang['edit_tdate']}&nbsp;<input class="form-control" style="width:140px;" data-rel="calendardate" type="text" name="toregdate" id="toregdate" value="{$toregdate}">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-4">{$lang['edit_entedate']}</label>
		  <div class="col-md-8">
			{$lang['edit_fdate']}&nbsp;<input class="form-control" style="width:140px;" data-rel="calendardate" type="text" name="fromentdate" id="fromentdate" value="{$fromentdate}">
			{$lang['edit_tdate']}&nbsp;<input class="form-control" style="width:140px;" data-rel="calendardate" type="text" name="toentdate" id="toentdate" value="{$toentdate}">
		  </div>
	    </div>
		<div class="form-group">
  ...
  <div class="panel-heading">
    ...
    <table class="table table-xs table-hover">
      ...
      <tr>
        ...
        <th class="hidden-xs" style="width: 40px"><i class="fa fa-file-text-o  tip" data-original-title="{$lang['rss_maxnews']}"></i></th>
        <th class="hidden-xs" style="width: 40px"><i class="fa fa-comments-o tip" data-original-title="{$lang['edit_com']}"></i></th>
...
HTML;
        ...
        <td class=\"hidden-xs\">{$news_link}</td>
        <td class=\"hidden-xs\">{$comms_link}</td>
...
function confirmDelete() {
	...
	DLEconfirm( '{$lang['user_deluser']}', '{$lang['p_confirm']}', function () {
		...
		document.location='{$_SERVER['PHP_SELF']}?mod=editusers&action=dodeleteuser&id={$row['user_id']}&user_hash={$dle_login_hash}';
...
echo <<<HTML
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<input class="form-control" type="text" style="width:220px;" data-rel="calendardatetime" name="time_limit" id="time_limit" value="{$row['time_limit']}">
				  </div>
				 </div>
				<div class="list-group-divider"></div>
				<div class="form-group">
...
<table width="98%">
    ...
    <tr>
        ...
        <td colspan="2"><input data-rel="calendardatetime" type="text" size="40" name="time_limit" id="time_limit" class="edit bk" value="{$row['time_limit']}"></td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
...
elseif( $action == "dodeleteuser" ) {
	...
	while ( $row = $db->get_array( $result ) ) {
		...
		$db->query( "DELETE FROM " . PREFIX . "_post_pass WHERE news_id = '{$row['news_id']}'" );
		$db->query( "DELETE FROM " . PREFIX . "_subscribe WHERE news_id = '{$row['news_id']}'" );
