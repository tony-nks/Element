...
if( $action == "list" ) {
	...
	while ( $row = $db->get_array() ) {
		...
		$entries .= "<tr><td class=\"hidden-xs hidden-sm text-nowrap\">{$itemdate}</td><td>";
...
HTML;
        ...
        <td class=\"hidden-xs\" style=\"text-align: center\"><a data-original-title=\"{$lang['st_views']}\" class=\"tip\" href=\"{$full_link}\" target=\"_blank\">{$row['news_read']}</a></td>";

		$entries .= "<td class=\"hidden-xs\" style=\"text-align: center\">{$comm_link}</td><td style=\"text-align: center\">";
		...
		$entries .= "<td class=\"hidden-xs\" style=\"text-align: center\">{$my_cat}</td>";
	...
	<div class="form-group">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div style="width:100%">{$lang['edit_fdate']} <input data-rel="calendar" class="form-control" style="width:160px;" type="text" name="fromnewsdate" id="fromnewsdate" value="{$fromnewsdate}">
				{$lang['edit_tdate']} <input data-rel="calendar" class="form-control" style="width:160px;" type="text" name="tonewsdate" id="tonewsdate" value="{$tonewsdate}"></div>
			</div>
		</div>
	</div>
	<div class="form-group">
  ...
  <div class="panel-heading">
    ...
    <table class="table table-striped table-xs">
      ...
      <tr>
        ...
        <th class="hidden-xs" style="width: 60px;text-align:center;"><i class="fa fa-comment-o tip" data-original-title="{$lang['edit_com']}"></i></th>
        <th style="width: 30px;text-align:center;">&nbsp;</th>
        <th class="hidden-xs" style="text-align:center;">{$lang['edit_cl']}</th>
...
HTML;
	...
	if( $user_group[$member_id['user_group']]['allow_main'] ) $main_input = "<div class=\"checkbox\"><label><input class=\"icheck\" type=\"checkbox\" id=\"allow_main\" name=\"allow_main\" value=\"1\" {$ifmain}>{$lang['addnews_main']}</label></div>"; else $main_input = "";
                     ...
                     <div class="tab-pane active" id="tabhome">
						<div class="panel-body">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-10">
								<input type="text" name="newdate" data-rel="calendar" class="form-control position-left" style="width:190px;" value="{$row['date']}"><label class="checkbox-inline"><input class="icheck" type="checkbox" name="allow_now" id="allow_now" value="yes">{$lang['edit_jdate']}</label>
							  </div>
							 </div>
...
{$output}
							...
							<div class="form-group">
							  ...
							  <div class="col-md-10">
								  <div class="row">
									<div class="col-sm-6" style="max-width:300px;"><div class="checkbox"><label><input class="icheck" type="checkbox" id="approve" name="approve" value="1" {$ifapp}>{$lang['addnews_mod']}</label></div></div>
									<div class="col-sm-6"><div class="checkbox"><label><input class="icheck" type="checkbox" id="allow_comm" name="allow_comm" value="1" {$ifch}>{$lang['addnews_comm']}</label></div></div>
								  </div>
								  <div class="row">
									<div class="col-sm-6" style="max-width:300px;">{$main_input}</div>
									<div class="col-sm-6">{$fix_input}</div>
								  </div>
								  <div class="row">
									<div class="col-sm-6" style="max-width:300px;"><div class="checkbox"><label><input class="icheck" type="checkbox" id="allow_rating" name="allow_rating" value="1" {$ifrat}>{$lang['addnews_allow_rate']}</label></div></div>
									<div class="col-sm-6">{$disable_index}</div>
								  </div>
								  <div class="row">
									<div class="col-sm-6" style="max-width:300px;">{$fix_br}</div>
									<div class="col-sm-6">{$disable_search}</div>
								  </div>
							  </div>
							 </div>
