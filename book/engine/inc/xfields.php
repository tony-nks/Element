  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10 col-sm-9">
			<input class="form-control width-200" maxlength="30" type="text" name="editedxfield[0]" value="<?php echo $editedxfield[0];?>" /><span class="text-muted text-size-small"><i class="fa fa-exclamation-circle position-left position-right"></i><?php echo $lang['xf_lat']; ?></span>
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3"><?php echo $lang['xfield_xdescr']; ?></label>
		  <div class="col-md-10 col-sm-9">
			<input class="form-control width-400" maxlength="100" type="text" name="editedxfield[1]" value="<?php echo $editedxfield[1];?>" />
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3"><?php echo $lang['xfield_hint']; ?></label>
		  <div class="col-md-10 col-sm-9">
			<input class="form-control width-400" maxlength="200" type="text" name="editedxfield[18]" value="<?php echo $editedxfield[18];?>" placeholder="<?php echo $lang['xfield_hint_1']; ?>" />
		  </div>
		 </div>
...
?>
		...
		<div class="form-group" id="default_textarea">
		  <label class="control-label col-md-2 col-sm-3"><?php echo $lang['xfield_xfaul']; ?></label>
		  <div class="col-md-10 col-sm-9">
			<textarea class="classic" style="width:100%;max-width: 400px;height: 100px;" name="editedxfield[4_textarea]"><?php echo ($editedxfield[3] == "textarea") ? $editedxfield[4] : "";?></textarea>
		  </div>
		 </div>	
		<div class="form-group" id="select_options">
		  <label class="control-label col-md-2 col-sm-3"><?php echo $lang['xfield_xfaul']; ?></label>
		  <div class="col-md-10 col-sm-9">
			<textarea class="classic" style="width:100%;max-width: 400px; height: 100px;" name="editedxfield[4_select]"><?php if ($editedxfield[4]{0} == "\r") $editedxfield[4] = "\n".$editedxfield[4]; echo ($editedxfield[3] == "select") ? $editedxfield[4] : "";?></textarea><div class="text-muted text-size-small"><?php echo $lang['xfield_xfsel']; ?></div>
		  </div>
		 </div>
...
<div id="$holderid" class="form-group editor-group" {$uid}>
  ...
  <div class="col-md-10">
     <div class="editor-panel{$noborder}">{$bb_pref}{$panel}<textarea style="width:100%;height:200px;" name="xfield[$fieldname]" id="xf_$fieldname" {$params}>{$fieldvalue}</textarea>{$bb_suff}</div>
  </div>
</div>
HTML;
...
HTML;
		...
		$fieldvalue = str_replace('"', '&quot;', $fieldvalue);
		$fieldvalue = str_replace('&afmp;', '&', $fieldvalue);
