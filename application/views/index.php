...
<body>
						...
						<ul class="clear-fix">
							<li>
								...
								<ul>
									...
									<li><a href="/adminpan/news/add">+Новость</a></li>
	...
	<div class="tp-banner-container">
		<div class="tp-banner-slider">
			<ul>
				...
				<li data-masterspeed="700">
					<img src="/rs-plugin/assets/loader.gif" data-lazyload="/rs-plugin/assets/bg-header.jpg" alt>
	 ...
	 data-transform_out="opacity:0;s:300;s:1000;" data-start="400">
   				...
   				<li data-masterspeed="700" data-transition="fade">
					<img src="/rs-plugin/assets/loader.gif" data-bgposition="center right"  data-lazyload="/rs-plugin/assets/bg-header.jpg" alt>
