                            ...
                            <div class="wt-top">
                                <div class="wt-img" style="background-image: url(/plugins/images/weather-bg.jpg);">
                                    <ul class="side-icon-text">
                                        <li><span class="di vm"><i class="wi wi-day-sunny"></i></span>
                                            <div class="di vm">
                                                <h1 class="m-b-0">25<sup>o</sup></h1>
                                                <h4>Mostly Sunny</h4>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="vcarousel slide">
                                ...
                                <div class="carousel-inner">
                                    <div class="active item">
                                        <div class="overlaybg"><img src="/plugins/images/heading-bg/slide6.jpg" alt="slide1" /></div>
                                    ...
                                    <div class="item">
                                        <div class="overlaybg"><img src="/plugins/images/heading-bg/slide4.jpg" alt="slide2" /></div>
                                        <div class="news-content"><span class="label label-primary label-rounded">Primary</span>
                                            <h2>It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</h2> <a href="#">Read More</a></div>
                                    </div>
                                    <div class="item">
                                        <div class="overlaybg"><img src="/plugins/images/heading-bg/slide6.jpg" alt="slide3" /></div>
